		...
		$elm$http$Http$get(
			{
				...
				au: $author$project$PhotoFolders$urlPrefix + 'folders/list'
			}));
};
...
var $author$project$PhotoGallery$initialModel = {J: '', _: 1, M: 5, O: 5, S: 5, p: $author$project$PhotoGallery$Loading};
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					r: $author$project$Main$FoldersPage(folders)
				}),
	...
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					r: $author$project$Main$GalleryPage(gallery)
				}),
...
var $author$project$Main$init = F3(
	function (version, url, key) {
		return A2(
			...
			url,
			{ai: key, r: $author$project$Main$NotFound, av: version});
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($author$project$PhotoGallery$viewFilter, $author$project$PhotoGallery$SlidRipple, 'Ripple', model.S),
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGallery$sizeToString(model._))
					]),
				A2(
					$elm$core$List$map,
...
var $author$project$Main$view = function (model) {
	...
	return {
		bg: _List_fromArray(
			[
				A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewHeader, model.r),
				content,
